...
-contributions
    Michael Allrich: Processfile, main
    Ke Wang: Traversal, read_line
    Lee Knutson: Create_node, Insert
    All: Lots of debugging and testing of different methods, and much like the last couple projects, we all were contributing/helping with other portions of the code.
